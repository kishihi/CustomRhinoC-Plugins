...
//     {
//         private readonly commands.RbfDeform.RBFLib.Deform _deform;
...
//             _deform = new commands.RbfDeform.RBFLib.Deform(baseObjRfs, targetObjRfs, limitedObjRfs, selectionOptions);
